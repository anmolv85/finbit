            ...
            <div className="container mx-auto px-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {featuresData.map((feature, index)=> (
                  <Card key={index} className="p-6 hover:shadow-lg transition-shadow cursor-pointer border-dashed">
      ...
      <Show when="signed-out">
        <section className="py-20 bg-blue-500">
            <div className="container mx-auto px-4 text-center">
              ...
              <Button asChild size="lg" className="bg-white text-blue-600 hover:bg-blue-50 animate-bounce">
                <Link href="/dashboard">
                  Start free Trial
                </Link>
              </Button>
         ...
         <Show when="signed-in">
             ...
             <p className="mb-6">
               Start your journey with Finbit
             </p>
